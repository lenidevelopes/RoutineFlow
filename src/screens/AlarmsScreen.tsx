...
import { Plus, Trash2, Bell, BellOff, Clock, X, Check, AlertCircle, ChevronUp, ChevronDown } from 'lucide-react';
...
export default function AlarmsScreen({ user }: AlarmsScreenProps) {
